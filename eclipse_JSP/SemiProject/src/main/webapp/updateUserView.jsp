		...
		<!-- 사용자 입력을 서버로 전송하기 위한 POST 메서드 폼 -->
			...
			<div class="form-group">
				...
				<div class="inline-input">
					...
					<!-- 닉네임 수정 필드 -->
					<button type="button" id="checkNicknameBtn" class="blue-button">중복 확인</button>
					<!-- 닉네임 중복 확인 버튼 -->
				</div>
			...
			<div class="form-group">
			    ...
			    <!-- 서버에서 전달된 passwordError가 있으면 오류 메시지 출력 -->
			...
			<div class="form-group">
				...
				<div class="inline-input email-container">
					...
					<input type="text" id="emailLocal" name="emailLocal" 
						value="${fn:substringBefore(user.userEmail, '@')}" autocomplete="off">
					<span>@</span>
					<!-- 이메일 도메인 선택 필드 -->
				...
				<!-- 직접 입력 도메인 필드 -->
				<div id="customDomainContainer" class="custom-domain" style="display: none;">
					<input type="text" id="customDomain" name="customDomain" placeholder="도메인 입력">
				</div>
			...
			<div class="form-buttons">
				...
				<!-- 서버로 폼 데이터 전송 -->
				<button type="button" onclick="location.href='mypageView.do';" class="cancel-button">취소</button>
