...
//	ID찾기 -------------------------------------------------------
	String selectLoginIdByEmail(String email);
	
//	PW찾기 -------------------------------------------------------
	UsersDTO selectUserByLoginIdAndEmail(@Param("loginId") String loginId, @Param("email") String email);

	int updatePassword(UsersDTO user);
